...
var dropy={$dropys:null,openClass:"open",selectClass:"selected",init:function(){this.$dropys=$(".dropy"),this.eventHandler()},eventHandler:function(){var t=this;t.$dropys.find(".dropy__title").click(function(){t.$dropys.removeClass(t.openClass),$(this).parents(".dropy").addClass(t.openClass)}),t.$dropys.find(".dropy__content ul li a").click(function(){var e=$(this),s=e.parents(".dropy"),i=s.find("input"),a=$(this).parents(".dropy").find(".dropy__title span");s.find(".dropy__content a").each(function(){$(this).removeClass(t.selectClass)}),a.html(e.html()),i.val(e.attr("data-value")).trigger("change"),e.hasClass("dropy__header")?(a.removeClass(t.selectClass),a.html(a.attr("data-title"))):(a.addClass(t.selectClass),e.addClass(t.selectClass)),s.removeClass(t.openClass)}),$(document).bind("click",function(e){$(e.target).parents().hasClass("dropy")||t.$dropys.removeClass(t.openClass)})}};$(function(){dropy.init()}),$(function(){$("button").on("click",function(){$(this).hasClass("active")?$(this).removeClass("active"):$(this).addClass("active")})}),$(".form").find("input, textarea").on("keyup blur focus",function(t){var e=$(this),s=e.prev("label");"keyup"===t.type?""===e.val()?s.removeClass("active highlight"):s.addClass("active highlight"):"blur"===t.type?""===e.val()?s.removeClass("active highlight"):s.removeClass("highlight"):"focus"===t.type&&(""===e.val()?s.removeClass("highlight"):""!==e.val()&&s.addClass("highlight"))}),$(".tab a").on("click",function(t){t.preventDefault(),$(this).parent().addClass("active"),$(this).parent().siblings().removeClass("active"),target=$(this).attr("href"),$(".tab-content > div").not(target).hide(),$(target).fadeIn(600)});var switchButton=document.querySelector(".switch-button"),switchBtnRight=document.querySelector(".switch-button-case.right"),switchBtnLeft=document.querySelector(".switch-button-case.left"),activeSwitch=document.querySelector(".switch-active");function switchLeft(){switchBtnRight.classList.remove("active-case"),switchBtnLeft.classList.add("active-case"),activeSwitch.style.left="0%"}function switchRight(){switchBtnRight.classList.add("active-case"),switchBtnLeft.classList.remove("active-case"),activeSwitch.style.left="50%"}switchBtnLeft.addEventListener("click",function(){switchLeft()},!1),switchBtnRight.addEventListener("click",function(){switchRight()},!1),checkCalc=function(t){t=t||"";var e=document.createElement("div");return e.style.cssText=t+"width: calc(1px);",!!e.style.length},checkAllCalc=function(){return checkCalc("-webkit-")||checkCalc("-moz-")||checkCalc()},checkVh=function(t){t=t||"";var e=document.createElement("div");return e.style.cssText=t+"width: 1vh;",!!e.style.length},0!=checkAllCalc&&0!=checkVh||$("body").addClass("not-supported");